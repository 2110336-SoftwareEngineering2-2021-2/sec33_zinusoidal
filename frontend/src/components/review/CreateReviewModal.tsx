    ...
    >
      {status == false ? (
        <>
          ...
          <Image
            src={providerInfo?.profilePicUrl}
          ...
          <TopicBox>
            <p>Topic: {data.service[0].service_type}</p>
            <p>
          ...
          <StarBox>
            <VscStarFull
              size={32}
              style={{ width: 48 }}
              color={rating >= 1 ? COLOR["violet/400"] : COLOR["gray/400"]}
              onClick={() => setStar(1)}
            />
            <VscStarFull
              size={32}
              style={{ width: 48 }}
              color={rating >= 2 ? COLOR["violet/400"] : COLOR["gray/400"]}
              onClick={() => setStar(2)}
            />
            <VscStarFull
              size={32}
              style={{ width: 48 }}
              color={rating >= 3 ? COLOR["violet/400"] : COLOR["gray/400"]}
              onClick={() => setStar(3)}
            />
            <VscStarFull
              size={32}
              style={{ width: 48 }}
              color={rating >= 4 ? COLOR["violet/400"] : COLOR["gray/400"]}
              onClick={() => setStar(4)}
            />
            <VscStarFull
              size={32}
              style={{ width: 48 }}
              color={rating >= 5 ? COLOR["violet/400"] : COLOR["gray/400"]}
              onClick={() => setStar(5)}
            />
          </StarBox>
          <CommentBox
        ...
        <FinView>
          <BsCheck2Circle size={96} color={COLOR["green/300"]} />
